  ...
  PermissionConstants
{
  ...
  function mintWithErc721(
    ...
    uint32 assetId = vault.tokenAssetId(tokenId);
    ...
    returns (bool)
  {
    ...
    return (spender == owner ||
      spender == address(0) || // add zero ex address
  ...
  {
    // this is an unrealistic amount of eth to bid
