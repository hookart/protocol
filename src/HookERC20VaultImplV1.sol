...
contract HookErc20VaultImplV1 is
  IHookERC20Vault,
  EIP712,
  Initializable,
  ReentrancyGuard
{
  ...
  function supportsInterface(
    ...
    return
      interfaceId == type(IHookERC20Vault).interfaceId ||
