...
contract HookCoveredCallBiddingRevertTests is HookProtocolTest {
    ...
    function test_SuccessfulAuctionAndSettlement() public {
        ...
        assertTrue(calls.currentBidder(optionId) == address(bidder1), "bidder1 should be in the lead");
        assertTrue(address(calls).balance == 1050, "bidder1 should have deposited money into escrow");
