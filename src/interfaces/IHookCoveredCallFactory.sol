...
interface IHookCoveredCallFactory {
    ...
    event CoveredCallInstrumentCreated(address assetAddress, address instrumentAddress);
    ...
    function getCallInstrument(address assetAddress) external view returns (address);
