...
interface IHookERC721VaultFactory {
    event ERC721VaultCreated(address nftAddress, uint256 tokenId, address vaultAddress);
    ...
    function getVault(address nftAddress, uint256 tokenId) external view returns (IHookERC721Vault);
    ...
    function getMultiVault(address nftAddress) external view returns (IHookERC721Vault);
    ...
    function makeSoloVault(address nftAddress, uint256 tokenId) external returns (IHookERC721Vault);
}
